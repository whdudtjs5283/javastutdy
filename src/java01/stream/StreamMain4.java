 ...
 * BiCousumer<A , T> accumulator() : 스트림의 요소를 어떻게 수집(collection) 할 방법 제공
 * BinaryOperator<A> combiner() : 두 저장공간을 병합할 방법을 제공(병렬 스트림)
 * Function<T, R> finsher() : 결과를 최종적으로 변환할 방법을 제공
 * set<Characteristics> characteristics() : 컬텍터가 수행하는 작업의 속성에 대한 정보를 제공
 */
